...
class Scanner:
    ...
    def get_token(self):
        ...
        if not len(self.input_string[self.current_char_index:]) == 0:
    ...
    def consume(self, *expected_tokens):
        ...
        if expected_tokens:
            ...
            self.next_token = self.get_token()
            return token, value if token in [Token.NUM, Token.ID] else token
...
# scanner: write, addition, subtraction, assignments, ends with a newline
# scanner: write, while-do-end, if-then-end, addition, assignments, ends with a newline
# scanner: read, while-do-end, if-then-end, addition, division, assignments
# scanner: read, write, while-do-end, addition, subtraction, assignments, ends with a newline
# scanner: read, write, nested while-do-end, multiplication, subtraction, assignments
# scanner: read, write, nested while-do-end, nested if-then-else-end, inequality, subtraction, assignments
# scanner: write, while-do-end, if-then-end, nested if-then-else-end, arithmetic, assignments
# scanner: read, write, nested while-do-end, if-then-end, if-then-else-end, arithmetic, assignments, ends with a newline
